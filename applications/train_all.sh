...
./train_comparison.sh supernova       432 432 432    432*432*432 \
    ...
    66 16 64:64          # number of params SNR=4609281, INR=??

./train_comparison.sh heatrelease_1atm     1152 320 853    576*320*426 \
    1atmheatrelease-20220916175751-network.json \
    98 16 64:64:64:64    # number of params SNR=??, INR=??

./train_comparison.sh heatrelease_10atm    1152 426 853    576*426*426  \
    10atmheatrelease-20220916180308-network.json \
    98 16 64:64:64:64    # number of params SNR=??, INR=??

./train_comparison.sh temp_1atm      1152 320 853    576*320*426 \
    1atmtemp-20220916180933-network.json  \
    114 16 64:64:64    # number of params SNR=??, INR=??

./train_comparison.sh temp_10atm     1152 426 853    576*426*426  \
    10atmtemp-20220916181605-network.json \
    114 16 64:64:64:64    # number of params SNR=??, INR=??
